...
public class UserCourseSqlProvider {
     ...
     */
    public String insertSelective(UserCourse record) {
        BEGIN();
        INSERT_INTO("usercourseinformation");
     ...
     * @mbggenerated Mon Jun 19 22:16:49 CST 2017
     */
    public String updateByPrimaryKeySelective(UserCourse record) {
        BEGIN();
